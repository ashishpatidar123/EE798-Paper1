...
class DatasetBase(Dataset):
    def __init__(self,
        ...
        self.interpolation = {"linear": Image.NEAREST,
...
class DIV2KTrain(DIV2KBase):
    def __init__(self, **kwargs):
        super().__init__(data_root="/content/drive/MyDrive/arbitrary-scale-diffusion-master/arbitrary-scale-diffusion-master/datasets/DIV2K_train_HR", repeat=20, augment=True, **kwargs)

class DIV2KValidation(DIV2KBase):
    def __init__(self, **kwargs):
        # super().__init__(data_root="../datasets/DIV2K_valid_HR", repeat=160, **kwargs)
        super().__init__(data_root="/content/drive/MyDrive/arbitrary-scale-diffusion-master/arbitrary-scale-diffusion-master/datasets/DIV2K_valid_HR", **kwargs)
